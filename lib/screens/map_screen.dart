...
class MarkerIndexProvider extends ChangeNotifier {
  int index = 0;
        ...
        child: Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () {
              ...
              // context.read<MarkerIndexProvider>().add();
              // _mapController.move(
              //     listSuggestItems[context.watch<MarkerIndexProvider>().index]
              //         .point,
              //     14);
            },
